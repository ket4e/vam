...
public class ImageFormatConverter : TypeConverter
{
	...
	public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
	{
		...
		{
			if (string.Compare(text, "Bmp", ignoreCase: true, CultureInfo.InvariantCulture) == 0)
			{
				return ImageFormat.Bmp;
			}
			if (string.Compare(text, "Emf", ignoreCase: true, CultureInfo.InvariantCulture) == 0)
			{
				return ImageFormat.Emf;
			}
			if (string.Compare(text, "Exif", ignoreCase: true, CultureInfo.InvariantCulture) == 0)
			{
				return ImageFormat.Exif;
			}
			if (string.Compare(text, "Gif", ignoreCase: true, CultureInfo.InvariantCulture) == 0)
			{
				return ImageFormat.Gif;
			}
			if (string.Compare(text, "Icon", ignoreCase: true, CultureInfo.InvariantCulture) == 0)
			{
				return ImageFormat.Icon;
			}
			if (string.Compare(text, "Jpeg", ignoreCase: true, CultureInfo.InvariantCulture) == 0)
			{
				return ImageFormat.Jpeg;
			}
			if (string.Compare(text, "MemoryBmp", ignoreCase: true, CultureInfo.InvariantCulture) == 0)
			{
				return ImageFormat.MemoryBmp;
			}
			if (string.Compare(text, "Png", ignoreCase: true, CultureInfo.InvariantCulture) == 0)
			{
				return ImageFormat.Png;
			}
			if (string.Compare(text, "Tiff", ignoreCase: true, CultureInfo.InvariantCulture) == 0)
			{
				return ImageFormat.Tiff;
			}
			if (string.Compare(text, "Wmf", ignoreCase: true, CultureInfo.InvariantCulture) == 0)
			{
				return ImageFormat.Wmf;
			}
		}
