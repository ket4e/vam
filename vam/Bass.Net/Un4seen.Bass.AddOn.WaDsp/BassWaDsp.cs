...
public sealed class BassWaDsp
{
	...
	{
		IntPtr intPtr = BASS_WADSP_GetNamePtr(plugin);
	...
	{
		IntPtr intPtr = BASS_WADSP_GetModuleNamePtr(plugin, module);
		if (intPtr != IntPtr.Zero)
		{
			return Utils.IntPtrAsStringAnsi(intPtr);
		}
	...
	public static string[] BASS_WADSP_GetModuleNames(int plugin)
	{
		...
		while (text != null)
		{
			text = BASS_WADSP_GetModuleName(plugin, num);
			num++;
			if (text != null)
			{
				list.Add(text);
	...
	{
		IntPtr intPtr = BASS_WADSP_PluginInfoGetNamePtr();
		if (intPtr != IntPtr.Zero)
		{
			return Utils.IntPtrAsStringAnsi(intPtr);
		}
	...
	{
		IntPtr intPtr = BASS_WADSP_PluginInfoGetModuleNamePtr(module);
		if (intPtr != IntPtr.Zero)
		{
			return Utils.IntPtrAsStringAnsi(intPtr);
		}
	...
	public static string[] BASS_WADSP_PluginInfoGetModuleNames()
	{
		...
		while (text != null)
		{
			text = BASS_WADSP_PluginInfoGetModuleName(num);
			num++;
			if (text != null)
			{
				list.Add(text);
	...
	{
		return Utils.LoadLib("bass_wadsp", ref _myModuleHandle);
	}

	public static bool LoadMe(string path)
	{
		return Utils.LoadLib(Path.Combine(path, "bass_wadsp"), ref _myModuleHandle);
	}
