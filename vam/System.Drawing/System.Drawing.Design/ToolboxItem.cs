...
public class ToolboxItem : ISerializable
{
	...
	public override bool Equals(object obj)
	{
		...
		return toolboxItem.AssemblyName.Equals(AssemblyName) && toolboxItem.Locked.Equals(locked) && toolboxItem.TypeName.Equals(TypeName) && toolboxItem.DisplayName.Equals(DisplayName) && toolboxItem.Bitmap.Equals(Bitmap);
	}
	...
	public virtual void Initialize(Type type)
	{
		...
		{
			if (obj is ToolboxBitmapAttribute toolboxBitmapAttribute)
			{
	...
	protected void ValidatePropertyType(string propertyName, object value, Type expectedType, bool allowNull)
	{
		...
		{
			string text = global::Locale.GetText("Type mismatch between value ({0}) and expected type ({1}).", value.GetType(), expectedType);
