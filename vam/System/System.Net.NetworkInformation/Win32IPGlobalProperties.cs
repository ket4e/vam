...
internal class Win32IPGlobalProperties : IPGlobalProperties
{
	...
	private unsafe void FillTcpTable(out List<Win32_MIB_TCPROW> tab4, out List<Win32_MIB_TCP6ROW> tab6)
	{
		...
		fixed (byte* ptr2 = &System.Runtime.CompilerServices.Unsafe.AsRef<byte>((byte*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref array2 != null && array2.Length != 0 ? ref System.Runtime.CompilerServices.Unsafe.As<byte, _003F>(ref array2[0]) : ref *(_003F*)null)))
		{
