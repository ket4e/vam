...
public class CUIGraphic : BaseMeshEffect
{
	...
	public void ReferenceCUIForBCurves()
	{
		...
		ref Vector3 reference = ref refCurves[0].ControlPoints[0];
		reference = refCUIGraphic.GetBCurveSandwichSpacePoint(vector.x, vector.y) - rectTrans.localPosition;
		ref Vector3 reference2 = ref refCurves[0].ControlPoints[3];
		reference2 = refCUIGraphic.GetBCurveSandwichSpacePoint(vector2.x, vector.y) - rectTrans.localPosition;
		ref Vector3 reference3 = ref refCurves[1].ControlPoints[0];
		reference3 = refCUIGraphic.GetBCurveSandwichSpacePoint(vector.x, vector2.y) - rectTrans.localPosition;
		ref Vector3 reference4 = ref refCurves[1].ControlPoints[3];
		reference4 = refCUIGraphic.GetBCurveSandwichSpacePoint(vector2.x, vector2.y) - rectTrans.localPosition;
		for (int i = 0; i < refCurves.Length; i++)
		{
			CUIBezierCurve cUIBezierCurve = refCurves[i];
			...
			ref Vector3 reference5 = ref cUIBezierCurve.ControlPoints[1];
			reference5 = _x - rectTrans.localPosition;
			ref Vector3 reference6 = ref cUIBezierCurve.ControlPoints[2];
			reference6 = _y - rectTrans.localPosition;
		}
	}
