...
public class BigInteger
{
	...
	internal sealed class Montgomery
	{
		...
		public unsafe static BigInteger Reduce(BigInteger n, BigInteger m, uint mPrime)
		{
			...
			fixed (uint* ptr = &System.Runtime.CompilerServices.Unsafe.AsRef<uint>((uint*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref n.data != null && n.data.Length != 0 ? ref System.Runtime.CompilerServices.Unsafe.As<uint, _003F>(ref n.data[0]) : ref *(_003F*)null)))
			{
				fixed (uint* ptr2 = &System.Runtime.CompilerServices.Unsafe.AsRef<uint>((uint*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref m.data != null && m.data.Length != 0 ? ref System.Runtime.CompilerServices.Unsafe.As<uint, _003F>(ref m.data[0]) : ref *(_003F*)null)))
				{
	...
	private sealed class Kernel
	{
		...
		public unsafe static void Multiply(uint[] x, uint xOffset, uint xLen, uint[] y, uint yOffset, uint yLen, uint[] d, uint dOffset)
		{
			...
			fixed (uint* ptr = &System.Runtime.CompilerServices.Unsafe.AsRef<uint>((uint*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref x != null && x.Length != 0 ? ref System.Runtime.CompilerServices.Unsafe.As<uint, _003F>(ref x[0]) : ref *(_003F*)null)))
			{
				fixed (uint* ptr4 = &System.Runtime.CompilerServices.Unsafe.AsRef<uint>((uint*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref y != null && y.Length != 0 ? ref System.Runtime.CompilerServices.Unsafe.As<uint, _003F>(ref y[0]) : ref *(_003F*)null)))
				{
					fixed (uint* ptr7 = &System.Runtime.CompilerServices.Unsafe.AsRef<uint>((uint*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref d != null && d.Length != 0 ? ref System.Runtime.CompilerServices.Unsafe.As<uint, _003F>(ref d[0]) : ref *(_003F*)null)))
					{
		...
		public unsafe static void SquarePositive(BigInteger bi, ref uint[] wkSpace)
		{
			...
			uint length = bi.length;
			bi.data = array;
			fixed (uint* ptr4 = &System.Runtime.CompilerServices.Unsafe.AsRef<uint>((uint*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref data != null && data.Length != 0 ? ref System.Runtime.CompilerServices.Unsafe.As<uint, _003F>(ref data[0]) : ref *(_003F*)null)))
			{
				fixed (uint* ptr = &System.Runtime.CompilerServices.Unsafe.AsRef<uint>((uint*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref array != null && array.Length != 0 ? ref System.Runtime.CompilerServices.Unsafe.As<uint, _003F>(ref array[0]) : ref *(_003F*)null)))
				{
