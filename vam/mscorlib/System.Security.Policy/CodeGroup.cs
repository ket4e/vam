...
public abstract class CodeGroup
{
	...
	public void FromXml(SecurityElement e, PolicyLevel level)
	{
		...
		else
		{
			...
			if (securityElement != null)
			{
				...
				permissionSet = (PermissionSet)Activator.CreateInstance(type, nonPublic: true);
		...
		if (securityElement3 != null)
		{
			...
			m_membershipCondition = (IMembershipCondition)Activator.CreateInstance(type2, nonPublic: true);
	...
	internal static CodeGroup CreateFromXml(SecurityElement se, PolicyLevel level)
	{
		...
		default:
		{
			...
			CodeGroup codeGroup = (CodeGroup)Activator.CreateInstance(type, nonPublic: true);
