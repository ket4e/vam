...
public class PrinterSettings : ICloneable
{
	...
	public PageSettings DefaultPageSettings
	{
		get
		{
			...
			{
				default_pagesettings = new PageSettings(this, SupportsColor, landscape: false, new PaperSize("A4", 827, 1169), new PaperSource("Tray", PaperSourceKind.FormSource), new PrinterResolution(200, 200, PrinterResolutionKind.Medium));
			}
