...
internal abstract class DataConverter
{
	...
	private class CopyConverter : DataConverter
	{
		...
		public unsafe override void PutBytes(byte[] dest, int destIdx, double value)
		{
			...
			fixed (byte* ptr2 = &System.Runtime.CompilerServices.Unsafe.AsRef<byte>((byte*)System.Runtime.CompilerServices.Unsafe.AsPointer(ref dest[destIdx])))
			{
				long* ptr = (long*)(&value);
				*(long*)ptr2 = *ptr;
			}
	...
	public static DataConverter LittleEndian => (!BitConverter.IsLittleEndian) ? SwapConv : CopyConv;

	public static DataConverter BigEndian => (!BitConverter.IsLittleEndian) ? CopyConv : SwapConv;
