...
public class FontConverter : TypeConverter
{
	...
	public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
	{
		...
		if (destinationType == typeof(InstanceDescriptor) && value is Font)
		{
			...
			ConstructorInfo constructor = typeof(Font).GetConstructor(new Type[4]
			{
				typeof(string),
				typeof(float),
				typeof(FontStyle),
			...
			return new InstanceDescriptor(constructor, new object[4] { font2.Name, font2.Size, font2.Style, font2.Unit });
		}
	...
	public override object CreateInstance(ITypeDescriptorContext context, IDictionary propertyValues)
	{
		...
		else
		{
			...
			foreach (FontFamily fontFamily2 in array)
			{
			...
			if (fontFamily == null)
			{
				...
				FontFamily[] array2 = families2;
				foreach (FontFamily fontFamily3 in array2)
				{
